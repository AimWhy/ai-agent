...
export function LoginForm({className, ...props}: React.ComponentProps<"form">) {
  ...
  async function onSubmit(values: WebPasswordLoginRequest) {
    await submit(values)
  }
      ...
      <FieldGroup>
        ...
        <Field>
          ...
          >
            ...
            {isGithubSubmitting ? "正在跳转 GitHub..." : "使用 GitHub 登录"}
          </Button>
          <FieldDescription className="text-center">
            预置账号: {seededWebAccount.email} / {seededWebAccount.password}
          </FieldDescription>
          <FieldDescription className="text-center">
            没有账号？{" "}
