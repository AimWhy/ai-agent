        ...
        <section className="px-5 py-5 lg:px-8">
          ...
          <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1fr)_22rem]">
            <section className="overflow-hidden rounded-2xl">
              <div className="grid auto-rows-[82px] grid-flow-dense grid-cols-1 gap-1 md:grid-cols-2 2xl:grid-cols-4">
                <article className="row-span-5 flex min-h-0 flex-col bg-white p-5 md:col-span-2">
                  ...
                  <div className="mt-auto grid grid-cols-3 border-t border-slate-200 pt-4">
                    <div>
                ...
                <article className="row-span-5 bg-white p-5 md:col-span-2">
                ...
                <article className="row-span-4 bg-white p-5 md:col-span-2">
                  <div className="mb-4 flex items-center justify-between border-b border-slate-200 pb-3">
                    <p className="flex items-center gap-2 text-sm font-semibold text-slate-950">
                ...
                <article className="row-span-4 bg-white p-5">
                  <p className="flex items-center gap-2 text-sm font-semibold text-slate-950">
